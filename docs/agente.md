...
Cursor **no** decide qué objetivo, rol, tema, tipo de publicación, cuenta o frecuencia toca. Eso ya lo preparó el Studio. El formato creativo se elige al desarrollar, filtrado por la restricción de producción.
...
4. Escribir 2–3 `Proposal` en `src/content/proposals.ts` con:
   ...
   - `brainRefs` del spec
5. No cambiar rol, tema, tipo de publicación, cuenta ni plataformas.
...
- No volver a decidir cuenta, rol, tema, tipo de publicación ni plataformas: eso ya lo fijó Planificación.
- Gemini en el Studio explora propuestas creativas (idea, visual, estructura). No escribe copy final.
- El desarrollo creativo (copy, caption, prompts) sigue en Cursor.
