...
/** Mix oficial equilibrado — perfil Institucional (2026-09-16). */
const DEFAULT_PRIORITY: Record<ContentRoleId, Record<string, TopicPriority>> = {
  build_in_public: {
    ...
    decisiones_priorizacion: "media",
    errores_aprendizajes: "media",
    crecimiento_distribucion: "media",
    metricas_traccion: "baja",
    tecnologia_construccion: "baja",
  ...
  educacion: {
    ventas_atencion: "media",
    inventario_stock: "media",
    catalogo_ecommerce: "alta",
    operacion_gestion: "baja",
    digitalizacion_sistemas: "baja",
    pedidos_logistica: "baja",
    conversion_trafico: "media",
    automatizacion_ia: "media",
    clientes_fidelizacion: "media",
    numeros_negocio: "baja",
    equipo_delegacion: "media",
    pagos_cobros: "media",
  },
  producto: {
    onboarding_tienda: "media",
    catalogo_importaciones: "alta",
    ia_catalogo: "alta",
    stock_variantes: "media",
    pedidos: "media",
    whatsapp: "baja",
    clientes_crm: "baja",
    pagos_cobros: "media",
    entrega_retiro: "baja",
    metricas: "baja",
    storefront_personalizacion: "alta",
    equipo_permisos: "media",
  ...
  marca: {
    ...
    orden_vs_fragmentacion: "media",
    sin_comision: "alta",
    filosofia_producto_ux: "alta",
    ia_operativa_control_humano: "baja",
    whatsapp_como_canal: "media",
    backoffice_vs_templates: "baja",
    vanguardia_ai_native: "media",
    identidad_latam: "no",
    futuro_ecommerce: "media",
    odisea_emprender: "media",
    marca_comunidad_distribucion: "no",
  },
  evidencia: {
    testimonios_citas: "media",
    casos_clientes: "baja",
    uso_real: "no",
    feedback_producto: "media",
    migraciones: "baja",
    feedback_implementado: "alta",
    historias_por_rubro: "no",
    antes_despues: "no",
    metricas_verificadas: "no",
    primeros_clientes_hitos: "no",
  },
  comunidad: {
    dolores_operativos: "baja",
    rutinas_negocio: "media",
    decisiones_dilemas: "alta",
    experiencias_comerciantes: "alta",
    opiniones_industria: "baja",
    preguntas_producto: "media",
    logros_fracasos: "baja",
    futuro_comercio_ia: "media",
    preguntas_fundadores: "media",
    co_creacion_features: "media",
    rubros: "baja",
  },
};
