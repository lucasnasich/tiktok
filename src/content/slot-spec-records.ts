...
export const slotSpecRecordSeeds: SlotSpecRecord[] = [
  {
    ...
    inspirationSearchBrief:
      "Buscá tier lists o rankings visuales sobre atención al cliente, postventa o recompra. Tiene que leerse el ranking en pantalla, sin talking head: placas con niveles, motion simple o capturas armadas.",
  },
  {
    slotId:
    ...
    inspirationSearchBrief:
      "Buscá piezas que abran con placa o titular de urgencia sobre caos de stock, faltantes o inventario desordenado. Sin presentador a cámara: texto grande, breaking news visual o montaje rápido de pantalla.",
  },
  {
    slotId:
