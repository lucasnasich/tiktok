...
**Snapshot:** 2026-09-10  
**Fuente:** relato de Lucas Nasich + perfil canónico de Mercantis.

Mercantis fue construido hasta este snapshot esencialmente por **dos personas: Lucas Nasich y Carla Palmieri**. No existe otro integrante que los fundadores identifiquen como fundamental en la historia del proyecto hasta este momento.

Familias y clientes fueron importantes como apoyo o validación, pero no hay un tercer integrante del equipo que deba documentarse como figura fundacional.

No convertir estas historias en bios corporativas de tres líneas.
...
Formación predominantemente técnica:
...
Esta trayectoria explica parte del perfil transversal: ingeniería, software/datos, diseño de producto, ventas y experiencia emprendiendo.
...
Las fechas exactas de cada transición no son necesarias para esta radiografía salvo que en el futuro se quiera producir una cronología pública detallada.
...
Separación natural de dominios:
...
Según Lucas, la infraestructura y el código fueron principalmente construidos y diseñados técnicamente por Carla.

La experiencia de producto, los flujos, la UX y gran parte de las funcionalidades fueron principalmente pensadas por Lucas.

Esta división no significa que trabajen de forma aislada: ambos participan en las decisiones y se corrigen mutuamente.
...
Relevante para comprender la cultura de ejecución. **No usar públicamente sin decisión explícita.**

## Voces editoriales

Lucas y Carla son las **principales voces humanas** de Mercantis. Detalle de tono y canales en `contenido-comunicacion.md`.

## Ver también

- `historia.md`
- `contenido-comunicacion.md`
- `tecnologia.md` (rol de Carla)
