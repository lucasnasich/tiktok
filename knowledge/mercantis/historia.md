...
**Snapshot:** 2026-09-10  
**Estado:** historical + contexto interno  
**Fuente:** relato directo de Lucas Nasich.

Este bloque es memoria institucional. Conserva el contexto humano, económico y de aprendizaje. **No convertirla en una cronología corporativa pulida.** Información personal no debe usarse como recurso emocional de marketing público sin decisión explícita de los fundadores.
...
**Uso público:** cliente identificable; antes de usar públicamente su historia debe confirmarse permiso. Ver `clientes-casos.md`.

## Evolución: de tienda online a all-in-one / sistema operativo

Mercantis no atravesó hasta ahora un pivot radical hacia un mercado completamente distinto. La evolución fue una **expansión de la tesis inicial**.
...
La tienda sigue siendo parte central de la experiencia, pero el roadmap ahora incorpora áreas propias de gestión: caja, facturación, sucursales, métricas financieras, proveedores y automatización cada vez más profunda. Esas áreas **no están todas live**. Ver `roadmap.md`.

## Situación personal y nivel de compromiso

**Alcance:** internal / personal
...
Este contexto explica tanto la velocidad de ejecución buscada como la presión por mejorar distribución y rentabilidad. **No debe utilizarse como recurso emocional de marketing público sin decisión explícita de los fundadores.**

## Señales de tracción al 10 de septiembre de 2026

**Estado:** hypothesis / snapshot interno aproximado — no publicar como claim hasta snapshot de base de datos.
...
La ambición es enorme, pero el fundador **no quiere confundir convicción con evidencia**.
...
Ésta es una de las razones por las que en septiembre de 2026 existe una prioridad fuerte por orgánico, redes, contenido y sistemas de producción de creativos (este Content Studio incluido).
...
## Adquisición: outbound vs. inbound

**Estado:** hypothesis operativa, no verdad universal.

La experiencia inicial sugiere que visitas en frío y llamados en frío pueden consumir mucho esfuerzo para un rendimiento limitado. Lucas considera que un buen sistema de inbound, apoyado en contenido y distribución orgánica, puede ser más productivo.

Detalle operativo en `growth-distribucion.md`.
...
Conclusión actual: el storefront debe ser bueno y pulido, pero **no necesita competir por cantidad de templates**. La ventaja estratégica debería venir del backoffice y de la capacidad de operar el negocio.
...
Actualmente el equipo está intentando acelerar estas áreas. **No están live.** Ver `roadmap.md`.
