...
**Snapshot:** 2026-09-10  
**Fuentes:** relato directo de Lucas; brief de marca y pautas de UX/copy de la landing.

Las referencias (Apple, Perplexity, etc.) son **brújula**, no estilos a copiar literalmente.
...
Detalle de producto de Argo: `inteligencia-artificial.md` y `roadmap.md`. **Argo no está disponible.**

## Qué representa el logo

El logo fue concebido por Lucas junto con el nombre y combina **tres símbolos** en una única marca:

1. **Barco:** el vehículo que atraviesa la odisea del emprendimiento.
2. **Ancla:** universo marítimo y la idea de estabilidad.
3. **Balanza/comercio:** intercambio comercial y la actividad del mercader.
...
## Tres adjetivos centrales

Ya definidos: **clara, confiable y operativa**.

- **Clara:** lenguaje comprensible, jerarquía visual y pocas decisiones innecesarias.
- **Confiable:** estabilidad, transparencia y evitar promesas que el producto no puede cumplir.
- **Operativa:** la comunicación tiene que ayudar a hacer cosas concretas: vender, cargar, ordenar, cobrar, entregar y entender el negocio.
...
Sí. La ambición es parte de la visión: construir una plataforma capaz de convertirse en el sistema operativo de referencia para negocios de distintos tamaños. Esa ambición debe expresarse mediante **producto y ejecución**, no mediante claims grandilocuentes sin evidencia.
...
## Postura contra el software viejo

Anti-desorden y anti-complejidad innecesaria.
...
**Regla:** mapa de afinidades, no receta de diseño. Mercantis debe mantener su universo propio: comercio + viaje + mar + Odisea/Argonautas + editorial + minimalismo + sistema operativo AI-native.

### Apple

Referencia visual y de producto más fuerte. Mercantis admira:
...
Referencia de **comunicación y campañas**. El fundador valora que una empresa masiva y consolidada siga produciendo campañas innovadoras, con ideas creativas reconocibles y no únicamente comunicación funcional.

### OpenAI

Parte de su estética, sistema visual y forma de presentar tecnología avanzada resulta atractiva.

### Anthropic

Referencia parcial de estética y presentación de una compañía AI-native: sobriedad, criterio editorial y capacidad de hacer que tecnología compleja se sienta entendible.

## Ver también

- `filosofia.md`
- `contenido-comunicacion.md`
- `inteligencia-artificial.md` (Argo como nombre de producto)
